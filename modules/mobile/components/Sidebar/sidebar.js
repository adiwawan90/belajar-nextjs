        ...
        <Drawer anchor="left" open={open} onClose={onClose}>
            <div className={classes.container}>
                <div className={classes.imgContainer}>
                    <img className={classes.img} src="/wegodev-logo.png" alt="wegdev-logo" />
                </div>
                <Grid
                    container
                ...
                >
                    ...
                    {
                        relatedCourseObj.map((obj) => {
                            return (
                                <Grid key={obj.name} item>
                                    <a href={obj.url} target="_blank" rel="noopenner" rel style={{textDecoration: 'none'}}>
                                        <Paper className={classes.relatedCourseCountainer}
                                            style={{background: `linear-gradient(45deg, #833ab4 30%, ${obj.color} 90% )`,
                                            }}
                                        >
